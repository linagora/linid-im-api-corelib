...
- remove AbstractAuthorizationPlugin from stateless AuthorizationPlugin
- AuthorizationPlugin to focus only on token validation

## [0.12.3] - 2026-03-16

### Fixed

- replace jpa by lighter dependency

## [0.12.2] - 2026-03-13

### Changed

- update spring-plugin-core to version 4.0.0
...
- make RoutePlugin stateless and rename RouteConfiguration name to type
...
[0.12.1]: https://github.com/linagora/linid-im-api-corelib/compare/v0.12.0...v0.12.1
[0.12.0]: https://github.com/linagora/linid-im-api-corelib/compare/v0.11.0...v0.12.0
