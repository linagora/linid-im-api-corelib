...
package org.linagora.linid.dmapicore.plugin.provider;
...
/**
 * Interface defining the contract for a provider plugin.
 *
 * <p>Each provider plugin manages dynamic entities according to its configuration and supports
 * typical CRUD operations (create, update, patch, delete, find).
 *
 * <p>The provider plugin is parameterized by a configuration of type {@link ProviderConfiguration}
 * that holds its specific settings.
 */
public interface ProviderPlugin extends Plugin<String> {
